...
@ -I/work/linux_code/linux-2.6.35.3/arch/arm/include -Iinclude
@ -Iarch/arm/mach-mx28/include -Iarch/arm/plat-mxs/include -imultilib
@ armv5te -iprefix
@ /opt/gcc-4.4.4-glibc-2.11.1-multilib-1.0/arm-fsl-linux-gnueabi/bin/../lib/gcc/arm-fsl-linux-gnueabi/4.4.4/
@ -isysroot
@ /opt/gcc-4.4.4-glibc-2.11.1-multilib-1.0/arm-fsl-linux-gnueabi/bin/../arm-fsl-linux-gnueabi/multi-libs
@ -D__KERNEL__ -D__LINUX_ARM_ARCH__=5 -Uarm -DKBUILD_STR(s)=#s
@ -DKBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -DKBUILD_MODNAME=KBUILD_STR(asm_offsets) -isystem
@ /opt/gcc-4.4.4-glibc-2.11.1-multilib-1.0/arm-fsl-linux-gnueabi/bin/../lib/gcc/arm-fsl-linux-gnueabi/4.4.4/include
...
@ -msoft-float -auxbase-strip arch/arm/kernel/asm-offsets.s -Os -Wall
